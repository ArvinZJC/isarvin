...
1. 此项目使用 [GPL-3.0 协议](./LICENSE)。截至 2022 年 3 月 20 日，使用 Visual Studio Code（版本：1.65.2）、Node.js 16.14.2 和 Vue CLI 5.0.3 开发表现良好。此外，我要特别感谢 Tailwind 提供的[丰富、可扩展的 CSS 框架和资源](https://tailwindcss.com/resources)，这节省了许多开发时间。
