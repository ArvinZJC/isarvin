...
1. 截至 2022 年 9 月 13 日，使用 Visual Studio Code（版本：1.71.0）、Node.js 16.16.0 和 Vite 3.1.0 开发表现良好。此外，我要特别感谢 Tailwind 提供的[丰富、可扩展的 CSS 框架和资源](https://tailwindcss.com/resources)，这节省了许多开发时间。
