...
1. 此项目使用 [GPL-3.0 协议](./LICENSE)。截至 2022 年 5 月 26 日，使用 Visual Studio Code（版本：1.67.2）、Node.js 16.15.0 和 Vite 2.9.9 开发表现良好。此外，我要特别感谢 Tailwind 提供的[丰富、可扩展的 CSS 框架和资源](https://tailwindcss.com/resources)，这节省了许多开发时间。
