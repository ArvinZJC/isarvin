...
1. By 8 July 2022, everything looks good with Visual Studio Code (Version: 1.69.0) + Node.js 16.15.0 + Vite 2.9.13. Additionaly, I would like to thankfully acknowledge Tailwind for [its rich and extensible CSS framework and resources](https://tailwindcss.com/resources), which save much development time.
