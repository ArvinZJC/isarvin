...
1. By 29 January 2022, everything looks good with Visual Studio Code (Version: 1.63.2) + Node.js 16.13.2 + Vue CLI 5.0.0-rc.1. Additionaly, I would like to thankfully acknowledge Tailwind for [its rich and extensible CSS framework and resources](https://tailwindcss.com/resources), which save much development time.
