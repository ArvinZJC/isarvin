...
1. The project is licensed under [the GPL-3.0 License](./LICENSE). By 7 May 2022, everything looks good with Visual Studio Code (Version: 1.67.0) + Node.js 16.14.2 + Vite 2.9.8. Additionaly, I would like to thankfully acknowledge Tailwind for [its rich and extensible CSS framework and resources](https://tailwindcss.com/resources), which save much development time.
