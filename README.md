...
1. By 14 August 2022, everything looks good with Visual Studio Code (Version: 1.70.1) + Node.js 16.16.0 + Vite 3.0.7. Additionally, I would like to thankfully acknowledge Tailwind for [its rich and extensible CSS framework and resources](https://tailwindcss.com/resources), which save much development time.
