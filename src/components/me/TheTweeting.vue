 ...
 * @LastEditTime: 2021-08-24 00:57:17
-->
...
<template>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-4 lg:pt-6 pb-12 sm:pb-20 lg:pb-24">
        ...
        <p class="max-w-2xl mx-auto mt-6 text-center text-sm text-gray-300 dark:text-gray-600">Don't get me wrong! Steve Jobz is Arvin. Arvin is me. I'm good at Hello World, so I'm on top of the world.😛</p>
    </div>
    <!-- Motto. -->
    <div class="relative overflow-hidden max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 lg:pt-24 pb-36 lg:pb-40">
        ...
        <svg class="absolute top-full left-0 transform translate-x-80 -translate-y-40 lg:hidden" width="784" height="404" fill="none" viewBox="0 0 784 404" aria-hidden="true">
            <defs>
                <pattern id="rect-points-rb" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="text-gray-200 dark:text-gray-700" fill="currentColor" />
                </pattern>
            </defs>
            <rect width="784" height="404" fill="url(#rect-points-rb)" />
        </svg>
        ...
        <svg class="hidden lg:block absolute right-full top-1/2 transform translate-x-1/2 -translate-y-1/2" width="404" height="784" fill="none" viewBox="0 0 404 784" aria-hidden="true">
            <defs>
                <pattern id="rect-points-l" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="text-gray-200 dark:text-gray-700" fill="currentColor" />
                </pattern>
            </defs>
            <rect width="404" height="784" fill="url(#rect-points-l)" />
        </svg>
        <div class="relative lg:flex lg:items-center">
            ...
            <div class="relative lg:ml-10">
                ...
                <blockquote class="relative">
                    <p class="font-serif italic text-justify text-xl leading-9 text-gray-900 dark:text-gray-50">
                    ...
                    <footer class="mt-8">
                        <div class="flex">
                            ...
                            <div class="ml-4 lg:ml-0">
                                <div class="text-base font-medium text-gray-900 dark:text-gray-50">Steve Jobs</div>
                                <div class="text-base font-medium text-purple-600 dark:text-purple-300">Co-founder, Apple Inc.</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
