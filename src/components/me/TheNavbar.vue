 ...
 * @Version: 1.5.2.20210826
 * @Author: Arvin Zhao
 * @Date: 2021-06-22 10:10:29
 * @Last Editors: Arvin Zhao
 * @LastEditTime: 2021-08-26 21:38:05
-->
...
<template>
	...
	<button @click="navigate('#home')" type="button" id="scroll-to-top" class="fixed bottom-44 right-4 sm:right-6 lg:right-8 z-30 rounded-full flex items-center justify-center h-12 w-12 bg-purple-600 bg-opacity-90 hover:bg-purple-700 dark:hover:bg-purple-500
		focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray-50 motion-safe:transition ease-out motion-safe:duration-300 opacity-0 translate-y-1 shadow-xl" title="Scroll to the top.">
