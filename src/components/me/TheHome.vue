...
<template>
	...
	<div id="home" class="flex flex-col sm:h-screen">
		...
		<div class="h-16 w-full bg-gradient-to-t from-indigo-600" />
		<div class="flex flex-col flex-grow items-center justify-between w-full bg-gradient-to-b from-indigo-600 to-purple-300 overflow-hidden sm:px-6 lg:px-8">
			...
			<svg class="relative z-10 h-16 sm:h-24 lg:h-32 w-screen mt-16 sm:mt-0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="none" shape-rendering="auto" viewBox="0 24 150 28">
				...
				<g class="motion-safe:waves">
					...
					<use class="fill-current text-indigo-100" xlink:href="#smooth-wave" x="48" y="7" />
				</g>
			</svg>
			<!-- Bubble animation. -->
...
export default {
	...
	methods: {
		...
		// Set the height of the bubbles area according to the height of the home section.
		setBubblesAreaHeight() {
			var home = document.getElementById("home");
			var bubbles = document.getElementById("bubble-animation");
			bubbles.style.height = home.offsetHeight + "px";
		} // end function setBubblesAreaHeight
	},
	data() {
